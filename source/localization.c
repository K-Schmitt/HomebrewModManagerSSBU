...
static const LocalizedStrings english_strings = {
    ...
    .mods_above = "^ More mods above",
    .mods_below = "v More mods below",
...
static const LocalizedStrings french_strings = {
    ...
    .enable_all = "Activer tous les mods",
    .disable_all = "Desactiver tous les mods",
    .mods_above = "^ Plus de mods au-dessus",
    .mods_below = "v Plus de mods en-dessous",
...
static const LocalizedStrings german_strings = {
    ...
    .enable_all = "Alle Mods aktivieren",
    .disable_all = "Alle Mods deaktivieren",
    .mods_above = "^ Weitere Mods oben",
    .mods_below = "v Weitere Mods unten",
...
static const LocalizedStrings spanish_strings = {
    ...
    .enable_all = "Activar todos los mods",
    .disable_all = "Desactivar todos los mods",
    .mods_above = "^ Mas mods arriba",
    .mods_below = "v Mas mods abajo",
...
static const LocalizedStrings italian_strings = {
    ...
    .enable_all = "Attivare tutti i mod",
    .disable_all = "Disattivare tutti i mod",
    .mods_above = "^ Altri mod sopra",
    .mods_below = "v Altri mod sotto",
